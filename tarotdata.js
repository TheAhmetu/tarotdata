// Shopify Premium kontrolü
window.customerIsPremium = false;
{% if customer %}
  {% if customer.tags contains 'premium' %}
    window.customerIsPremium = true;
  {% endif %}
{% endif %}
window.PREMIUM_URL = "https://ryoyw9bw2sg20ju9-76214108384.shopifypreview.com/products/premium-tarot-uyeligi";

// Dil desteği ve metinler
const LANGS = { tr:"Türkçe", en:"English" };
let LANG = (localStorage.getItem("LANG")||"tr");
const L = {
  tr: {
    siteTitle:"✨ Hoş Geldiniz!",
    intro:"<b>Tarot Falı ile geleceğinize ışık tutun.</b><br>Klasik tarot destesiyle, enerjinizi ve kaderinizi birlikte keşfedelim.<br>Şu anda <b>3 Kartlık Açılım</b> ve <b>Premium Açılımlar</b> hizmetimiz açık!",
    secim1:"3 Kartlık Tarot Açılımı",
    secim2:"Aşk Açılımı",
    secim3:"Kariyer Açılımı",
    premium:"Premium",
    labelName:"Ad Soyad",
    labelBirthDate:"Doğum Tarihi",
    labelBirthTime:"Doğum Saati (opsiyonel)",
    devam:"Devam Et 🧿",
    phase:["Geçmiş için bir kart seç","Şimdiki zaman için bir kart seç","Gelecek için bir kart seç","Kartların ve yorumları:"],
    card_result:"🃏 Çektiğin Kartlar ve Uzun Yorumlar",
    summary:"Tarot Açılımı Özet Yorumun:",
    cardContext: {
      past: { ask: "Geçmiş aşk hayatında", kariyer: "Geçmiş kariyer yolculuğunda" },
      present: { ask: "Şu an aşk hayatında", kariyer: "Şu an kariyerinde" },
      future: { ask: "Aşk hayatında gelecekte", kariyer: "Kariyerinde gelecekte" }
    }
  },
  en: {
    siteTitle:"✨ Welcome!",
    intro:"<b>Shed light on your future with Tarot Reading.</b><br>Let's discover your energy and destiny together with the classic tarot deck.<br>Currently, <b>3 Card Spread</b> and <b>Premium Spreads</b> are available!",
    secim1:"3 Card Tarot Spread",
    secim2:"Love Spread",
    secim3:"Career Spread",
    premium:"Premium",
    labelName:"Full Name",
    labelBirthDate:"Date of Birth",
    labelBirthTime:"Time of Birth (optional)",
    devam:"Continue 🧿",
    phase:["Pick a card for the Past","Pick a card for the Present","Pick a card for the Future","Cards and their meanings:"],
    card_result:"🃏 Your Cards & Detailed Interpretations",
    summary:"Tarot Reading Summary:",
    cardContext: {
      past: { ask: "In your love life in the past", kariyer: "In your career in the past" },
      present: { ask: "Currently in your love life", kariyer: "Currently in your career" },
      future: { ask: "In your love life in the future", kariyer: "In your career in the future" }
    }
  }
};
